...
{{- if .Values.app-deployment.fullnameOverride -}}
{{- .Values.app-deployment.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $defaultName := default .Chart.Name .Values.app-deployment.nameOverride -}}
